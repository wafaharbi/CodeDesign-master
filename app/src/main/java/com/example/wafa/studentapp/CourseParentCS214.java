...
public class CourseParentCS214 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_parent_cs214);
    ...
    public  void show(DataSnapshot dataSnapshot){
        ...
        for(DataSnapshot ds: dataSnapshot.getChildren()) {
            ...
            final String attendance = info.setAttendance(dataSnapshot.child("CS214").child("attendance").getValue().toString());
            final String quiz = info.setQuize(dataSnapshot.child("CS214").child("quiz").getValue().toString());
            final String mid = info.setMid(dataSnapshot.child("CS214").child("mid").getValue().toString());
            final String finals = info.setFinals(dataSnapshot.child("CS214").child("finals").getValue().toString());
