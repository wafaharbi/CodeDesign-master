...
public class CourseParentCS383 extends AppCompatActivity {
    ...
    public  void show(DataSnapshot dataSnapshot){
        ...
        for(DataSnapshot ds: dataSnapshot.getChildren()) {
            ...
            final String attendance = info.setAttendance(dataSnapshot.child("CS383").child("attendance").getValue().toString());
            final String quiz = info.setQuize(dataSnapshot.child("CS383").child("quiz").getValue().toString());
            final String mid = info.setMid(dataSnapshot.child("CS383").child("mid").getValue().toString());
            final String finals = info.setFinals(dataSnapshot.child("CS383").child("finals").getValue().toString());
