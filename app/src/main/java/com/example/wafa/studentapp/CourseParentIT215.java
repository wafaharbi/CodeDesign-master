...
public class CourseParentIT215 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_parent_it215);
    ...
    public  void show(DataSnapshot dataSnapshot){
        ...
        for(DataSnapshot ds: dataSnapshot.getChildren()) {
            ...
            final String attendance = info.setAttendance(dataSnapshot.child("IT215").child("attendance").getValue().toString());
            final String quiz = info.setQuize(dataSnapshot.child("IT215").child("quiz").getValue().toString());
            final String mid = info.setMid(dataSnapshot.child("IT215").child("mid").getValue().toString());
            final String finals = info.setFinals(dataSnapshot.child("IT215").child("finals").getValue().toString());
