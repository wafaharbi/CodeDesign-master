...
public class CourseStudentCS214 extends AppCompatActivity {

    //databaseReference
    private DatabaseReference mUserDatabase,currentUser;
...
//Android Layout
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_student_cs214);
        ...
        //Student
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("Student").child(current_uid).child("CS214");
