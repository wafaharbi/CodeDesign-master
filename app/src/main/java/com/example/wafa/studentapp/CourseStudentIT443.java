...
public class CourseStudentIT443 extends AppCompatActivity {
...
//Android Layout
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_student_it443);
        ...
        //Student
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("Student").child(current_uid).child("IT443");
