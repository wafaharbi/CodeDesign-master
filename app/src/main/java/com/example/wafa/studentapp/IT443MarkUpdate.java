...
public class IT443MarkUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_it443_mark_update);
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("Student").child(user_id).child("IT443");
    ...
    public  void update(View v){
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                IT443MarkUpdate.this.finish();

              /*  Intent i =new Intent(getApplicationContext(), editStudentIT443.class);
                startActivity(i);*/
