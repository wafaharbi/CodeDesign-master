...
public class ParentHome extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Parents").child(fuser.getUid());
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    Picasso.with(ParentHome.this).load(image).placeholder(R.drawable.default_img).into(profile);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_profile:
                ...
                //ProfileActivity  = ParentInfo
                Intent x = new Intent(this, ParentProfile.class);
                startActivity(x);
                break;
            ...
            case R.id.nav_out:
                ...
                finish();
                Intent v = new Intent(this,LoginParent.class);
                startActivity(v);
    ...
    public void chat(View v){
        ...
        Intent k = new Intent(this, ParentChatTeacher.class);
        startActivity(k);
    }
