...
public class StudentHome extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    Picasso.with(StudentHome.this).load(image).placeholder(R.drawable.default_img).into(profile);
    ...
    public void GoToCourses(View v){
        Intent i = new Intent(this, CourseViewInfo.class);   //FilesUpload
        startActivity(i);
    }
  ...
  /*  public void Schedule(View v){
        ...
        Intent k = new Intent(this, Schedule.class);
        startActivity(k);*/
    }
