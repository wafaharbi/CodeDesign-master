...
public class StudentUpdateInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String id = getIntent().getExtras().get("username").toString();
        key.setText(" Student ID: " + id);




        ref = FirebaseDatabase.getInstance().getReference() .child("Student").child(u.getUid());
    ...
    public  void update(View v){
        ...
        final Student user =new Student(n,e,p);
