...
public class TeacherChatsStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_chats_student);
//Arrow to return back
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<User , TeacherChatsStudent.UserViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<User, TeacherChatsStudent.UserViewHolder>(
                User.class,
                R.layout.user_single_item,
                TeacherChatsStudent.UserViewHolder.class,
                mDatabase
        ) {
            @Override
            protected void populateViewHolder(TeacherChatsStudent.UserViewHolder viewHolder, User model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(TeacherChatsStudent.this, MessageTeacherStudent.class);
