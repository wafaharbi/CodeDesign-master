...
public class editStudentCS214 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_student_cs214);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Student").child(user_id).child("CS214");
        ...
        for (DataSnapshot ds : dataSnapshot.getChildren()) {
            ...
            btnEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(getApplicationContext(), CS214MarkUpdate.class);
