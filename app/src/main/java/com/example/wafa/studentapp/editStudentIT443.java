...
public class editStudentIT443 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_student_it443);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Student").child(user_id).child("IT443");
        ...
        for (DataSnapshot ds : dataSnapshot.getChildren()) {
            ...
            btnEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(getApplicationContext(), IT443MarkUpdate.class);
