...
public class editStudentIT473 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_student_it473);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Student").child(user_id).child("IT473");
        ...
        for (DataSnapshot ds : dataSnapshot.getChildren()) {
            ...
            btnEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(getApplicationContext(), IT473MarkUpdate.class);

                    i.putExtra("user_id" , user_id);
                    i.putExtra("attendance", info.getName());
